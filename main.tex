...
\newcommand\tab[1][1cm]{\hspace*{#1}} % tab
...
\multicolumn{5}{V{5}lV{5}}{\begin{tabular}[c]{@{}l@{}}\color{redd}\textbf{UWAGI} (wypełnia prowadzący):\\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\  \end{tabular}}                                                                                                              \\ \hlineB{6}
\end{tabular}
\end{adjustbox}
\end{table}
\newpage
